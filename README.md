...
- `docs/`: General project documentation, planning, and interaction history.
- `eda/`: Code and documentation related to the EDA architecture.
- `weather/`: Code and resources for the weather model integration.
